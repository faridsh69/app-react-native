...
export const isNumber = (variable: unknown): variable is number => typeof variable === 'number' && !isNaN(variable)
...
export const isObjectEmpty = (object: unknown): boolean => !object || !isObject(object) || !Object.keys(object).length
